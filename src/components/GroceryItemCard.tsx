  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        <p className="text-xs text-gray-500 font-bold mb-1">{item.category}</p>
        <h3 className="text-xl font-bold">{item.name}</h3>
        <div className="flex items-center justify-between mt-2">
          <span className="text-xs text-gray-600 font-bold bg-gray-100 px-2 py-1 rounded-full">
            {item.unit}
          </span>
        ...
        {!cartItem ? (
          ...
          <motion.div
            ...
            className="mt-4 flex items-center justify-center bg-green-50 border-gray-200 rounded-full py-2 px-4 gap-4"
          >
            <button
